...
#Put all the above into a function with more veritile options
#that can be imported and run from other scripts.

def ran_trials(file0,nperm = 4,ofac=10.,hifac=1.0):
    '''
