...
def fasper(x,y,ofac,hifac, MACC=4):
  ...
  #Estimate amplitudes of peaks with FAP of 0.001, 0.01, and 0.05
  #FAPvals = array([0.001, 0.01, 0.05])
  cvals = array([0.683, 0.955, 0.997])
  FAPvals = 1. - cvals
  pvals = -log(1.-(1.-FAPvals)**(1./effm))
  ampvals = sqrt(4.*var*pvals/n)
